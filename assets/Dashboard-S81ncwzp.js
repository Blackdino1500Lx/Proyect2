import{g as t,a as r,N as a,c as b,t as f,f as $}from"./index-eaBcYPEU.js";async function x(l,v){l.innerHTML='<div class="page active" id="page-dash"><p style="color:var(--text3);font-size:.85rem">Cargando...</p></div>';const[o,c,m,p]=await Promise.all([t("meetings"),t("announcements"),t("assignments"),t("reports")]),g=r().users,h=r().groups,u=a.toISOString().split("T")[0],e=[...o].sort((s,i)=>s.date.localeCompare(i.date)).find(s=>s.date>=u),d=e?new Date(e.date+"T00:00:00"):null,n=m.find(s=>s.email===v.email&&s.week===b()),y=p.filter(s=>s.year===a.getFullYear());l.innerHTML=`<div class="page active" id="page-dash">
